...
module Apartment
  ...
  class << self
    ...
    ACCESSOR_METHODS  = [:use_schemas, :use_sql, :seed_after_create, :prepend_environment, :append_environment, :with_multi_server_setup, :with_multi_server_setup_and_schemas]
    ...
    def_delegators :connection_class, :connection, :connection_config, :establish_connection, :connection_handler, :connection_handler=
